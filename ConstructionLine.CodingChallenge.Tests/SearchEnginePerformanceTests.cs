...
namespace ConstructionLine.CodingChallenge.Tests
{
    ...
    public class SearchEnginePerformanceTests : SearchEngineTestsBase
    {
        ...
        [Test]
        public void PerformanceTestWithEmptySearchOptions()
        {
            ...
            SearchOptions optionsWithoutColors = new SearchOptions { Colors = null, Sizes= new List<Size> { Size.Small }};
            Assert.Throws<ArgumentException>(() =>
            {
                _searchEngine.Search(optionsWithoutColors);
            });

            SearchOptions optionsWithoutSizes = new SearchOptions { Colors = new List<Color> { Color.Black, Color.Blue}, Sizes = null };
            Assert.Throws<ArgumentException>(() =>
            {
                _searchEngine.Search(optionsWithoutSizes);
            });
        }
